...
function submitform() {
 ...
 //var collectvalidation = '<?php echo($collectthis) ?>';
   ...
   // var valid = submitme(1, undefined, 'new_user', collectvalidation);
    //if (!valid) return;
// Custom code changes by Mahesh Kunta
...
<td>
<a class="btn btn-default btn-save" name='form_save' id='form_save' href='#' onclick="submitform();">
...
<tr>
<td style="width:150px;"><span class="text"><?php xl('Email','e'); ?>: </span></td><td  style="width:220px;"><input type="entry" id="email" name="email" style="width:120px;"> <span class="mandatory">&nbsp;*</span></td>
<td style="width:150px;"><span class="text"><?php xl('Servicing Provider','e'); ?>: </span></td>
<td><input type='checkbox' name='servicingprovider' value='1' /></td>
</tr>
<!-- end -->
<!-- Sai custom code end -->
<tr>
...
if ($fres) {
    ...
    ?>
<option value="0">Select</option> <!-- code added for default --> <!-- Sai custom code  -->
<?php
