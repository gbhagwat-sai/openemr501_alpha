...
ini_set('memory_limit', '512M');// Sai custom code
use Dotenv\Dotenv;
...
if(!empty($_POST['clientname'])){
	...
	$clientselected = strtolower($clientname);
	$_SESSION['site_id'] = $clientselected ;
	$_GET['site_id'] = $clientselected ;
}
  ...
  //
    ...
    while ($glrow = sqlFetchArray($glres)) {
      ...
      // Adjust for user specific settings
		...
		//	echo array((new DateTime())->format("P"));
...
//////////////////////////////////////////////////////////////////
// Sai custom code start
/**********code added for view facesheet and progress note*************/


//print_r($_SERVER);
//$billehrUploadPath = 'https://52.179.124.176/billEHRWebUat/public/billEHRUploads';

//$billehrUploadPath = 'https://rcm.saisystemshealth.com/billEHRWebUat/public/billEHRUploads';
if(isset($_SESSION['site_id'])){

  if($_SESSION['site_id'] == 'mp')
    $client = 'mpb';
  elseif($_SESSION['site_id'] == 'gm')
    $client = 'gmb';
  else
