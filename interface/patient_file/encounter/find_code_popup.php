...
//Issue:Need to display diagnosis code in the issues tab
$diagnosis_code = $_GET['diagnosis_code'];
if($diagnosis_code)
{
	$diagnosis_code_new1 = str_replace(";",",",$diagnosis_code);
	$diagnosis_code_new2 = str_replace("ICD9:","",$diagnosis_code_new1);
}
$diagnosis_code_final= htmlentities($diagnosis_code_new2, ENT_QUOTES, "UTF-8");
$form_code_type = $_POST['form_code_type'];
$diagnosis_code_new = $_POST['diagnosis_code_new'];
// Sai custom code end
...
<?php } ?>
<input type=hidden name='diagnosis_code_new' value='<?php echo $diagnosis_code_final; ?>'><!--Sai custom code -->
<center>
