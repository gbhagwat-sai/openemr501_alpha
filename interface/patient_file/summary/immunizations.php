...
if (isset($_GET['mode'])) {
    ...
    if ($_GET['mode'] == "add") {
        ...
        $administered_date = date('m/d/Y H:i'); // Sai custom code
        $education_date = date('m/d/Y'); // Sai custom code
...
<br>
    ...
    title='<?php echo htmlspecialchars(xl('mm/dd/yyyy'), ENT_QUOTES); ?>'><!-- Sai custom code -->
    />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <input type='text' size='10' class='datepicker' name="education_date" id="education_date"
                    ...
                    title='<?php echo htmlspecialchars(xl('mm/dd/yyyy'), ENT_QUOTES); ?>'
