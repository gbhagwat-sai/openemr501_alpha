...
<div class='tabContainer' >
  <div class='tab current' >
    ...
    if (!$thisauth) {
        ...
        $pres = getPatientData($pid, "lname, fname,pubpid");
	...
	$external_id = $pres['pubpid'];// Sai custom code
        ...
        if ($result != null) {
            ...
            foreach ($result as $iter) {
                ...
                echo "<td valign='top' class='text'>".htmlspecialchars(oeFormatDateTime(date('m/d/Y H:i', strtotime($iter['date']))), ENT_NOQUOTES)."</td>\n";// Sai custom code
    ...
    if ( $has_log < 1 ) { ?>
        <span class='text'>
            <?php echo htmlspecialchars(xl( "There are no logs of statement for this patient."),ENT_NOQUOTES);
                  echo " ";
    ...
    <?php } else {
        ...
        <br/>
        <span class='text'>
	    <?php echo htmlspecialchars(xl('Displaying the following number of most recent logs:'),ENT_NOQUOTES); ?> 
	    <b><?php echo $N;?></b><br>
	 ...
	 <!-- code added for showing statement log for BUG ID 10485  end---------->
       <!-- Sai custom code end -->
<?php } ?>
    </div>
    <?php if ($GLOBALS['portal_offsite_enable'] == 1) { ?>
