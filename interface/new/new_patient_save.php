...
$result = sqlQuery("select max(pid)+1 as pid, MAX(CONVERT(SUBSTRING_INDEX(pubpid,'-',-1),UNSIGNED INTEGER))+1 as pubpid from patient_data");// Sai custom code 
...
//end table lock
$newpid = 1;
$newpubpid = 1; //BUG ID 10346 BY Gangeya // Sai custom code 
...
if (isset($_POST["pubpid"]) && ($_POST["pubpid"] != "")) {
  ...
  $mypubpid = $newpubpid; //BUG ID 10346 BY Gangeya
}
// Sai custom code end
