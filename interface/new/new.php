...
$form_regdate   = $_POST['regdate'  ] ? trim($_POST['regdate'  ]) : date('m/d/Y'); // Sai custom code
?>
<html>
...
<?php } ?>
 ...
 <tr>
  ...
  <!-- Sai custom code start -->
   <input type='text' size='8' maxlength='8' class='datepicker' name='DOB' id='DOB'
 ...
 <tr<?php echo $regstyle ?>>
  ...
  <td>
   <input type='text' size='10' maxlength='8' class='datepicker' name='regdate' id='regdate'
