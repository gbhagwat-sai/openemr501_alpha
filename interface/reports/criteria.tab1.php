...
$ThisPageSearchCriteriaDisplay=explode(',',$ThisPageSearchCriteriaDisplayMaster);
...
for($ThisPageSearchCriteriaIndex=0;$ThisPageSearchCriteriaIndex<sizeof($ThisPageSearchCriteriaDataType);$ThisPageSearchCriteriaIndex++) 
 {
    ...
    if($ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex]=='query_drop_down')
	 ...
	 if($ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex]=='query_drop_down1')
     {
        $NumberOfQueryDropDownThisPageSearchCriteria++;
        $ThisPageSearchCriteriaQueryDropDown[$ThisPageSearchCriteriaIndex]=$NumberOfQueryDropDownThisPageSearchCriteria;    
     }
          ...
          <tr>
                  ...
                  <tr>
                    ...
                    <!-- Below section comes as per the defined criteria arrays.Initially all are hidden.As per the click the corresponding items gets visible. -->
                        ...
                        <?php 
                            if($ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex]=='query_drop_down')
                             {							 
                              $array_query_drop_down=BuildArrayForReport($ThisPageSearchCriteriaQueryDropDownMaster[$ThisPageSearchCriteriaQueryDropDown[$ThisPageSearchCriteriaIndex]],$ThisPageSearchCriteriaIndex);
                            ...
                            <table width="150" border="0" cellspacing="0" cellpadding="0" 
                              ...
                              <tr> 
                                ...
                                '<?php echo $ThisPageSearchCriteriaDisplay[$ThisPageSearchCriteriaIndex] ?>',
                                    ...
                                    '<?php echo $ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex] ?>')" multiple="multiple">
                                                                      
                                   <?php /*?> <option value="<?php echo $ThisPageSearchCriteriaQueryDropDownDefaultKey[$ThisPageSearchCriteriaIndex] ?>"
                                    ><?php echo $ThisPageSearchCriteriaQueryDropDownDefault[$ThisPageSearchCriteriaIndex] ?></option><?php */?>
                        ...
                        ?>
                            <table width="150" border="0" cellspacing="0" cellpadding="0" 
                              ...
                              <tr> 
                                ...
                                <select style="width:200px;"  name="query_drop_down_master_<?php echo $QueryDropDownNamePart;?>[]" 
                                id="query_drop_down_master_<?php echo $QueryDropDownNamePart;?>" onchange="appendOptionRadioCriteria2(
                                '<?php echo $ThisPageSearchCriteriaDisplay[$ThisPageSearchCriteriaIndex] ?>',
                                    '<?php echo $ThisPageSearchCriteriaKey[$ThisPageSearchCriteriaIndex] ?>',this.options[this.selectedIndex].text,
                                    this.options[this.selectedIndex].value,' = ',
                                    '<?php echo $ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex] ?>','query_drop_down_master_<?php echo $QueryDropDownNamePart;?>')" multiple="multiple">
            ...
            <td valign="top"><fieldset style="border-color:#000000; border-width:1px;padding-left:5px;padding-right:0px;padding-top:0px;padding-bottom:0px;" >
                ...
                <table width="260" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td colspan="2"><select name='final_this_page_criteria[]' id='final_this_page_criteria'  
                        size='8' style="width:335px;"   class='text'  title='Criteria' multiple="multiple" >
                        <?php 
                ...
                <?php 
                             /*?>if($ThisPageSearchCriteriaDataType[$ThisPageSearchCriteriaIndex]=='query_drop_down')
                             {
                              $array_query_drop_down=BuildArrayForStatReport("SELECT status,id  FROM claim_status");
                              $QueryDropDownNamePart=str_replace('.','_',$ThisPageSearchCriteriaKey[$ThisPageSearchCriteriaIndex]);
                        ?>
                            <table width="150" border="0" cellspacing="0" cellpadding="0" 
                                id="table_<?php echo $ThisPageSearchCriteriaKey[$ThisPageSearchCriteriaIndex] ?>" style="display:none">
