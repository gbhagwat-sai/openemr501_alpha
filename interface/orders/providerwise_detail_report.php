...
if ($_POST['form_csvexport']) {
  ...
  header("Content-Disposition: attachment; filename=Providerwise_Detail_Report.csv");
...
<title><?php xl('Providerwise Detail Report','e') ?></title>
</head>

<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
<center>

<h2><?php xl('Providerwise Detail Report','e')?></h2>

<form method='post' action='providerwise_detail_report.php'>
