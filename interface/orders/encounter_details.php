...
if ($_POST['form_csvexport']) {
  ...
  header("Content-Disposition: attachment; filename=encounter_details.csv");
  ...
  echo '"' . xl('Encounter') . '",';
  echo '"' . xl('DOS') . '",';
  echo '"' . xl('Entered Date') . '",';
  echo '"' . xl('Person Entered') . '",';
  echo '"' . xl('Provider') . '",';
...
<title><?php xl('Encounter Details','e') ?></title>
</head>

<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
<center>

<h2><?php xl('Encounter Details','e')?></h2>

<form method='post' action='encounter_details.php'>
...
<table border='0' cellpadding='3'>
 ...
 <tr>
  <td>
   ...
   <?php xl(' Charge Entry Date From:','e')?>
...
$query = "select b.pid As PID,pd.pubpid as ExternalID, ".
		...
		"where b.date >= '$from_date 00:00:00'  ".
		"and  b.date <= '$to_date 23:59:59' ".
