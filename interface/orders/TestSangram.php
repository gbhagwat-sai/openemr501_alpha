...
?>
 <tr>
  <td class="detail"><?php echo $row['id'  ]; ?></td>
  <td class="detail"><?php echo $row['fname'        ]; ?></td>
  <td class="detail"><?php echo $row['lname'  ]; ?></td>
  <td class="detail"><?php echo $row['mname'  ]; ?></td>
  <td class="detail"><?php echo oeFormatShortDate($row['DOB'  ]); ?></td>
  <td class="detail"><?php echo $row['street']; ?></td>
  <td class="detail"><?php echo $row['city' ]; ?></td>
  <td class="detail"><?php echo $row['state'   ]; ?></td>
 </tr>
<?php
  } // End not csv export
}
...
<table border='0' cellpadding='1' cellspacing='2' width='98%'>
 <tr bgcolor="#dddddd">
  ...
  <td class="dehead"><?php xl('fname','e'       ) ?></td>
  <td class="dehead"><?php xl('lname','e'  ) ?></td>
  <td class="dehead"><?php xl('mname','e'     ) ?></td>
  <td class="dehead"><?php xl('DOB','e') ?></td>
  <td class="dehead"><?php xl('street','e' ) ?></td>
  <td class="dehead"><?php xl('city','e' ) ?></td>
  <td class="dehead"><?php xl('state','e'   ) ?></td>
 </tr>
<?php
} // end not export
