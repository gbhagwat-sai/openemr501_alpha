...
if ($_POST['form_csvexport']) {
  ...
  header("Content-Disposition: attachment; filename=CPT_Count_Report.csv");
...
<title><?php xl('CPT Count Report','e') ?></title>
</head>

<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>
<center>

<h2><?php xl('CPT Count Report','e')?></h2>

<form method='post' action='cpt_count_report.php'>
