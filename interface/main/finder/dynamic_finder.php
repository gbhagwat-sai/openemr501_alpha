...
$from_enc = $_GET['from_enc']; // Sai custom code
...
$(document).ready(function() {
 ...
 $("div.mytopdiv").html("<form name='myform'><input type='checkbox' name='form_new_window' value='1'<?php
  ...
  //echo xlt('Open in New Window'); ?></form>"); // Sai custom code
...
<?php if($from_enc==1) { ?>
 document.location.href = "../../forms/newpatient/new.php?from_finder=1&set_pid=" + newpid; 
<?php
