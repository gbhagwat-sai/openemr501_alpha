<?php /* Smarty version 2.6.31, created on 2020-10-08 06:44:08
         compiled from default/user/ajax_search.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/user/ajax_search.html', 16, false),array('modifier', 'escape', 'default/user/ajax_search.html', 45, false),)), $this); ?>
...
<br>
<?php  xl('between','e');  ?>
<input type="text" class='datepicker' name="start" id="start" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['DATE_START'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" size="10"/>
<input type="text" class='datepicker' name="end" id="end" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['DATE_END'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" size="10"/>
<br>
<?php  xl('for','e');  ?>
