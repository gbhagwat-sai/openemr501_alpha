<?php /* Smarty version 2.6.31, created on 2019-10-04 07:11:03
         compiled from C:%5Cdocroot%5Cinterface%5Cforms%5Cvitals/templates/vitals/general_new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', 'C:\\docroot\\interface\\forms\\vitals/templates/vitals/general_new.html', 31, false),array('function', 'math', 'C:\\docroot\\interface\\forms\\vitals/templates/vitals/general_new.html', 151, false),array('modifier', 'date_format', 'C:\\docroot\\interface\\forms\\vitals/templates/vitals/general_new.html', 131, false),array('modifier', 'string_format', 'C:\\docroot\\interface\\forms\\vitals/templates/vitals/general_new.html', 193, false),array('modifier', 'substr', 'C:\\docroot\\interface\\forms\\vitals/templates/vitals/general_new.html', 286, false),)), $this); ?>
<html>
<head>
...
<?php echo $GLOBALS['assets_static_relative']; ?><?php echo '/jquery-min-1-7-2/index.js\'><\\/script>'; ?>
")
}
</script>
...
<?php echo smarty_function_xl(array('t' => 'Weight'), $this);?>
<?php echo '\' + \' (\' + \''; ?>
<?php echo smarty_function_xl(array('t' => 'lbs'), $this);?>
<?php echo '\' + \')\';
...
<?php echo smarty_function_xl(array('t' => 'Weight'), $this);?>
<?php echo '\' + \' (\' + \''; ?>
<?php echo smarty_function_xl(array('t' => 'kg'), $this);?>
<?php echo '\' + \')\';

	elementsToValidate[2] = new Array();
	elementsToValidate[2][0] = \'height_input\';
	elementsToValidate[2][1] = \''; ?>
<?php echo smarty_function_xl(array('t' => "Height/Length"), $this);?>
<?php echo '\' + \' (\' + \''; ?>
...
<?php echo '\';
	...
	for (var i = 0; i < elementsToValidate.length; i++) {
		...
		if (isNaN(document.getElementById(current_elem_id).value)) {
			invalid += "'; ?>
<?php echo smarty_function_xl(array('t' => 'The following field has an invalid value'), $this);?>
<?php echo '" + ": " + tag_name + "\\n";
	...
	if (invalid.length > 0) {
		invalid += "\\n" + "'; ?>
<?php echo smarty_function_xl(array('t' => "Please correct the value(s) before proceeding!"), $this);?>
<?php echo '";
		alert(invalid);
...
<div id="chart" class="chart-dygraphs"></div>
<table>
...
'>
    <input type='text' size='14' class='datetimepicker' name='date' id='date'
...
?>
	...
	<?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus graph" id="weight"><?php else: ?><td class="graph" id="weight"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Weight'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'lbs'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' name='weight' id='weight_input' value="<?php if ($this->_tpl_vars['vitals']->get_weight() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_weight(); ?>
<?php endif; ?>" onChange="convLbtoKg('weight_input');" title='<?php echo smarty_function_xl(array('t' => "Decimal pounds or pounds and ounces separated by #(e.g. 5#4)"), $this);?>
'/>
                </td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
	...
	<?php if ($this->_tpl_vars['units_of_measurement'] == 3): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus graph" id="weight_metric"><?php else: ?><td class="graph" id="weight_metric"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Weight'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'kg'), $this);?>
</td>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' id='weight_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_weight() != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['vitals']->get_weight(),'constant' => 0.45359237,'format' => "%.2f"), $this);?>
<?php endif; ?>" onChange="convKgtoLb('weight_input');"/>
                </td>
        <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
                <td  class='historicalvalues'><?php if ($this->_tpl_vars['result']['weight'] != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['result']['weight'],'constant' => 0.45359237,'format' => "%.2f"), $this);?>
<?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
	        <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus graph" id="height"><?php else: ?><td class="graph" id="height"><?php endif; ?><?php echo smarty_function_xl(array('t' => "Height/Length"), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'in'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' name='height' id='height_input' value="<?php if ($this->_tpl_vars['vitals']->get_height() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_height(); ?>
<?php endif; ?>" onChange="convIntoCm('height_input');"/>
                </td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['height'] != 0): ?><?php echo $this->_tpl_vars['result']['height']; ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 3): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus graph" id="height_metric"><?php else: ?><td class="graph" id="height_metric"><?php endif; ?><?php echo smarty_function_xl(array('t' => "Height/Length"), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'cm'), $this);?>
</td>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' id='height_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_height() != 0): ?><?php echo smarty_function_math(array('equation' => "round(number * constant,1)",'number' => $this->_tpl_vars['vitals']->get_height(),'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?>" onChange="convCmtoIn('height_input');"/>
                </td>
        <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
                <td class='historicalvalues'><?php if ($this->_tpl_vars['result']['height'] != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['result']['height'],'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?></tr>
...
?>
	...
	<tr><td class="graph" id="pulse"><?php echo smarty_function_xl(array('t' => 'Pulse'), $this);?>
			...
			<td class='currentvalues'><input type="text" size='5'
			name='pulse' id='pulse_input' value="<?php if ($this->_tpl_vars['vitals']->get_pulse() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_pulse())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?>"/></td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['pulse'] != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['result']['pulse'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>
	...
	<tr><td class="graph" id="respiration"><?php echo smarty_function_xl(array('t' => 'Respiration'), $this);?>
		...
		<td class='currentvalues'><input type="text" size='5'
			name='respiration' id='respiration_input' value="<?php if ($this->_tpl_vars['vitals']->get_respiration() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_respiration())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?>"/></td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['respiration'] != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['result']['respiration'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
	        <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus graph" id="temperature"><?php else: ?><td class="graph" id="temperature"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Temperature'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'F'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' name='temperature' id='temperature_input' value="<?php if ($this->_tpl_vars['vitals']->get_temperature() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_temperature(); ?>
<?php endif; ?>" onChange="convFtoC('temperature_input');"/>
                </td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['temperature'] != 0): ?><?php echo $this->_tpl_vars['result']['temperature']; ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 3): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus graph" id="temperature_metric"><?php else: ?><td class="graph" id="temperature_metric"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Temperature'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'C'), $this);?>
</td>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' id='temperature_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_temperature() != 0): ?><?php echo smarty_function_math(array('equation' => "(number - constant2 ) * constant",'number' => $this->_tpl_vars['vitals']->get_temperature(),'constant' => 0.5556,'constant2' => 32,'format' => "%.2f"), $this);?>
<?php endif; ?>" onChange="convCtoF('temperature_input');"/>
                </td>
        <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
                <td class='historicalvalues'><?php if ($this->_tpl_vars['result']['temperature'] != 0): ?><?php echo smarty_function_math(array('equation' => "(number - constant2 ) * constant",'number' => $this->_tpl_vars['result']['temperature'],'constant' => 0.5556,'constant2' => 32,'format' => "%.2f"), $this);?>
<?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?></tr>
...
<td></td></td>
    ...
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['temp_method']): ?><?php echo smarty_function_xl(array('t' => $this->_tpl_vars['result']['temp_method']), $this);?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>
	...
	<tr><td class="graph" id="oxygen_saturation"><?php echo smarty_function_xl(array('t' => 'Oxygen Saturation'), $this);?>
		...
		<td class='currentvalues'><input type="text" size='5'
			name='oxygen_saturation' id='oxygen_saturation_input' value="<?php if ($this->_tpl_vars['vitals']->get_oxygen_saturation() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_oxygen_saturation())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?>"/></td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td  class='historicalvalues'><?php if ($this->_tpl_vars['result']['oxygen_saturation'] != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['result']['oxygen_saturation'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 4 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
	        <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus graph" id="head_circ"><?php else: ?><td class="graph" id="head_circ"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Head Circumference'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'in'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' name='head_circ' id='head_circ_input' value="<?php if ($this->_tpl_vars['vitals']->get_head_circ() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_head_circ(); ?>
<?php endif; ?>" onChange="convIntoCm('head_circ_input');"/>
                </td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['head_circ'] != 0): ?><?php echo $this->_tpl_vars['result']['head_circ']; ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 3 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus graph" id="head_circ_metric"><?php else: ?><td class="graph" id="head_circ_metric"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Head Circumference'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'cm'), $this);?>
</td>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' id='head_circ_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_head_circ() != 0): ?><?php echo smarty_function_math(array('equation' => "round(number * constant,1)",'number' => $this->_tpl_vars['vitals']->get_head_circ(),'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?>" onChange="convCmtoIn('head_circ_input');"/>
                </td>
        <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
                <td class='historicalvalues'><?php if ($this->_tpl_vars['result']['head_circ'] != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['result']['head_circ'],'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 4 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
	        <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus graph" id="waist_circ"><?php else: ?><td class="graph" id="waist_circ"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Waist Circumference'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'in'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' name='waist_circ' id='waist_circ_input' value="<?php if ($this->_tpl_vars['vitals']->get_waist_circ() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_waist_circ(); ?>
<?php endif; ?>" onChange="convIntoCm('waist_circ_input');"/>
                </td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['waist_circ'] != 0): ?><?php echo $this->_tpl_vars['result']['waist_circ']; ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>

	<?php if ($this->_tpl_vars['units_of_measurement'] == 3 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus graph" id="waist_circ_metric"><?php else: ?><td class="graph" id="waist_circ_metric"><?php endif; ?><?php echo smarty_function_xl(array('t' => 'Waist Circumference'), $this);?>
</td>
		<?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xl(array('t' => 'cm'), $this);?>
</td>
                <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="text" size='5' id='waist_circ_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_waist_circ() != 0): ?><?php echo smarty_function_math(array('equation' => "round(number * constant,1)",'number' => $this->_tpl_vars['vitals']->get_waist_circ(),'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?>" onChange="convCmtoIn('waist_circ_input');"/>
                </td>
        <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
                <td class='historicalvalues'><?php if ($this->_tpl_vars['result']['waist_circ'] != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['result']['waist_circ'],'constant' => 2.54,'format' => "%.2f"), $this);?>
<?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?></tr>
	...
	<tr><td class="graph" id="BMI"><?php echo smarty_function_xl(array('t' => 'BMI'), $this);?>
		...
		<td class='currentvalues'><input type="text" size='5'
			name='BMI' id='BMI_input' value="<?php if ($this->_tpl_vars['vitals']->get_BMI() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_BMI())) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 5) : substr($_tmp, 0, 5)); ?>
<?php endif; ?>"/></td>
	<?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
		<td class='historicalvalues'><?php if ($this->_tpl_vars['result']['BMI'] != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['result']['BMI'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 5) : substr($_tmp, 0, 5)); ?>
<?php endif; ?></td>
	<?php endforeach; endif; unset($_from); ?></tr>
...
"/></td>
  <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
    <td  class='historicalvalues'><?php if ($this->_tpl_vars['result']['BMI_status']): ?><?php echo smarty_function_xl(array('t' => $this->_tpl_vars['result']['BMI_status']), $this);?>
<?php endif; ?></td>
...
" style='margin-left: 20px;'> -->
 ...
 (<?php echo smarty_function_xl(array('t' => 'HTML'), $this);?>
	...
	<tr>
	<td colspan='3' style='text-align:center'>
        <input type="submit" class="editonly" name="Submit" value="<?php echo smarty_function_xl(array('t' => 'Save'), $this);?>
">
        <input type="button" class="editonly" id="cancel" value="<?php echo smarty_function_xl(array('t' => 'Cancel'), $this);?>
">
        </td>
</tr>
</table>
