<?php /* Smarty version 2.6.31, created on 2020-10-21 06:43:46
         compiled from default/views/month/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/month/ajax_template.html', 10, false),array('modifier', 'date_format', 'default/views/month/ajax_template.html', 347, false),array('modifier', 'string_format', 'default/views/month/ajax_template.html', 348, false),)), $this); ?>
...
<?php 
echo "   <a id='prevmonth' href='$PREV_MONTH_URL' onclick='top.restoreSession()' title='" . xl("Previous Month") . "'>
            <i class='fa fa-chevron-circle-left chevron_color' aria-hidden='true'></i></a>\n";;
echo xl(date('F', strtotime($Date))) . " " . date('Y', strtotime($Date));
echo "   <a id='nextmonth' href='$NEXT_MONTH_URL' onclick='top.restoreSession()' title='" . xl("Next Month") . "'>
...
foreach ($providers as $provider) {
    ...
    foreach ($A_EVENTS as $date => $events) {
        ...
        echo "<td class='schedule " . $classForWeekend . "'>";
