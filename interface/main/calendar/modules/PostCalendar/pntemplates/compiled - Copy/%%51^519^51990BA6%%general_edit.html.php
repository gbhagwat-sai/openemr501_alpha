<?php /* Smarty version 2.6.31, created on 2020-04-07 09:06:35
         compiled from C:/docroot/templates/insurance_companies/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'C:/docroot/templates/insurance_companies/general_edit.html', 13, false),array('function', 'xl', 'C:/docroot/templates/insurance_companies/general_edit.html', 16, false),array('function', 'html_options', 'C:/docroot/templates/insurance_companies/general_edit.html', 106, false),)), $this); ?>
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="attn" class="control-label col-sm-2"><?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Insurance Code')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
</label>
        <div class="col-sm-8">
            <input type="text" id="attn" name="ins_code" class="form-control" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['insurancecompany']->get_ins_code())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" onKeyDown="PreventIt(event)">
        </div>
    </div>
...
" onKeyDown="PreventIt(event)">
    ...
    <!-- Sai custom code start -->
<!-- code added for patient statement BUG 11205------->
<div class="form-group">
        <label for="statement_limit" class="control-label col-sm-2"><?php echo smarty_function_xl(array('t' => ((is_array($_tmp='Statement Limit')) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))), $this);?>
</label>
        <div class="col-sm-8">
             <input type="text" id="statement_limit" name="statement_limit" class="form-control" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['insurancecompany']->get_statement_limit())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" onKeyDown="PreventIt(event)">
        </div>
    </div>
...
// Sai custom code start
$(function() {
  $(\'#disc_amount1\').on(\'change\', function(e) {
    e.stopPropagation();
