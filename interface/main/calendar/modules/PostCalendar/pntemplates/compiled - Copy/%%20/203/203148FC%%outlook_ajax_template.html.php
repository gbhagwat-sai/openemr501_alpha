<?php /* Smarty version 2.6.31, created on 2019-05-17 08:48:19
         compiled from default/views/day_print/outlook_ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day_print/outlook_ajax_template.html', 10, false),array('function', 'pc_sort_events', 'default/views/day_print/outlook_ajax_template.html', 285, false),array('modifier', 'date_format', 'default/views/day_print/outlook_ajax_template.html', 280, false),array('modifier', 'string_format', 'default/views/day_print/outlook_ajax_template.html', 281, false),)), $this); ?>
...
<?php 
    ...
    echo "<br><span style='font-size:0.8em;font-weight:normal'>".xl(date('l', strtotime($atmp[0])))."</span>";
    echo "</span>";
    echo "</div>";
...
foreach ($times as $slottime) {
    ...
    if ($starttimem == "00") { echo "<b>$disptimeh:$starttimem</b>"; }
    else { echo "$disptimeh:$starttimem"; }
    echo "</td></tr>\n";
}
echo "</table></div></td>";
