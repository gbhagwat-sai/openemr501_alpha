...
//It opens the corresponding pages.
    ...
    if(rawdata=='')
     ...
     else if(rawdata=='Unbilled Encounter')
     {
     		top.window.parent.left_nav.loadFrame2('nen1','RTop','forms/newpatient/unbilled_encounters.php')
		return true;
     }
...
<td style="margin:3px 0px 3px 0px;vertical-align:middle;">
        <div style='margin-left:10px; float:left; ' id="current_patient_block">
...
<td style="margin:3px 0px 3px 0px;vertical-align:middle;" align="left">
    ...
    <tr><td valign="baseline" align="center">
        <div style='' class='text' id="current_encounter_block" >
