...
<?php require($GLOBALS['srcdir'] . "/restoreSession.php"); ?>
 ...
 function add_edit_X12() {
  dlgopen('../../controller.php?practice_settings&x12_partner&action=list&position=+popup+', '_blank', 600, 700);
  return false;
 }
 // sai custom code end
</script>
...
<table border='0' width='100%'>
 ...
 <tr>
  <td valign='top' nowrap><b><?php xl('CMS/Payer ID','e');?>:</b></td><!-- sai custom code -->
  <td>
...
?>
 ...
 <tr>
  ...
  <td>
   <select name='form_partner' id="form_partner" title='Default X12 Partner' class="input-sm"><!-- sai custom code -->
...
?>
   ...
   <a id="sup0" onClick="javascript:add_edit_X12()" >Add/Edit</a><!-- sai custom code -->
  </td>
 </tr>
