...
<html>
  ...
  <body class="body_top">
    <form method="post" <?php echo "name='my_form' " . "action='$rootdir/forms/misc_billing_options/save.php?id=" . attr($formid) . "'>\n";?>
      ...
      <label for="addl_notes"><?php echo xlt('BOX 19. :Additional Notes:'); ?>
      <textarea cols="40" rows="4" wrap="virtual" name="comments" id="addl_notes" maxlength="71"><?php echo text($obj{"comments"}); ?></textarea ><br><br>
      <div>
      <!-- Save/Cancel buttons -->
