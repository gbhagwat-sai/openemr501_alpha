...
if ($_POST['form_save']) {
  ...
  $lines = $_POST['line'];
	...
	$Check_date= date("Y-m-d",strtotime($_POST['form_check_date'])) ;
...
<?php } ?>
  ...
  f.form_amount1.value = total.toFixed(<?php echo $currdecimals ?>);
  return true;
 }
...
<body class="body_top" onLoad="LoadingForm();">

<form method='post' action='pos_checkout.php' onSubmit="return executeOnSubmit();">
...
<table border='0' cellspacing='4'>
 ...
 <tr>
  ...
  <td>
   <select name='form_method' id="form_method" onChange="PaymentMetodChanged(this);">
<?php
...
?>
 ...
 <tr>
  ...
  <td>
   <input type='text' name='form_source' id="form_source" size='10' value=''>
  </td>
 </tr>
...
<!--  rename 'Amount paid' to 'Check amount'-->
  ...
  <td>
   <input type='text' name='form_amount1' id="form_amount1" size='10' value='0.00' readonly>
  </td>
 </tr><?php */?>
 <tr>
  <td>
...
?>
 ...
 <tr>
  <td colspan='2' align='center'>
   &nbsp;<br>
   <input type='submit' name='form_save' value='<?php xl('Post the payment','e'); ?>' /> &nbsp;
...
<script language='JavaScript'>
 Calendar.setup({inputField:"form_date", ifFormat:"%m/%d/%Y", button:"img_date"});
 Calendar.setup({inputField:"form_check_date", ifFormat:"%m/%d/%Y", button:"img_check_date"});
 computeTotals();
<?php
