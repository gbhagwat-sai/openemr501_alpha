<?php
ini_set('memory_limit', -1); // Sai custom code
// +-----------------------------------------------------------------------------+
...
//===============================================================================
	...
	$QueryString.="Select * from  ar_session where (length(reference)>'0' or (payment_type like '%$PayingEntity%' and pay_total!=0 ))  and "; // Sai custom code
        $And='';
...
<table width="560" border="0"  cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" align="left"><b><?php echo htmlspecialchars( xl('Payments'), ENT_QUOTES) ?></b>  <br></td><!-- Sai custom code -->
  </tr>
  <tr height="15">
    <td colspan="3" align="left" ><hr size="2" color= "#000000"></td> <!-- Sai custom code -->
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" align="left" >
    <table width="974" border="0" cellspacing="0" cellpadding="10" bgcolor="#c1eafa"><tr><td><!-- Sai custom code -->
            ...
            <td colspan="4">
                <table  border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<td><input type='text'  style="width:90px;" name='FromDate' id='FromDate' class="datepicker" value='<?php echo htmlspecialchars($FromDate); ?>' onkeyup='datekeyup(this)' onBlur="dateblur(this,mypcc,'<?php echo date("m/d/Y"); ?>')"  /><!-- Sai custom code -->
					...
					<td><input type='text'  style="width:103px;"  name='ToDate' id='ToDate' class="datepicker" value='<?php echo htmlspecialchars($ToDate); ?>' onkeyup='datekeyup(this)' onBlur="dateblur(this,mypcc,'<?php echo date("m/d/Y"); ?>')"  /><!-- Sai custom code -->
					   <img src='../../interface/main/calendar/modules/PostCalendar/pntemplates/default/images/new.jpg' align="texttop"
