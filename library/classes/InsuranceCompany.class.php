...
class InsuranceCompany extends ORDataObject
{
	...
	*/
	...
	// code added for patient statement
	var $statement_limit;
	var $disc_amount;
	// Sai custom code end
    /**
	...
	// added by sangram on 28 feb 2014 for bug 8446
	function set_ins_code($ins_code) {
		$this->ins_code = $ins_code;
	}
	function get_ins_code() {
		return $this->ins_code;
	}
	// added for patient statement
	function set_statement_limit($statement_limit) {
		$this->statement_limit = $statement_limit;
	}
	function get_statement_limit() {
		return $this->statement_limit;
	}
	function set_disc_amount($disc_amount) {
		$this->disc_amount = $disc_amount;
	}
	function get_disc_amount() {
