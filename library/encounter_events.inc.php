...
$device_type = "OE";// Sai custom code
$today=date('Y-m-d');
//===============================================================================
...
function todaysEncounterCheck($patient_id, $enc_date = '', $reason = '', $fac_id = '', $billing_fac = '', $provider = '', $cat = '', $return_existing = true)
{
    ...
    addForm(
        ...
        sqlInsert(
            ...
            "encounter = ?," .
            "pc_catid = ?".
	    "device_type = ?," . // added for BUG ID 1521 // Sai custom code
	    	"created_date = ?",// added for BUG ID 1521 // Sai custom code
            	array($dos,$visit_reason,$facility,$facility_id,$billing_facility,$visit_provider,$patient_id,$encounter,$visit_cat,$device_type,$todays_date)// added for BUG ID 1521 // Sai custom code
        ),
        "newpatient",
        $patient_id,
        "1",
...
function todaysEncounter($patient_id, $reason = '')
{
  ...
  *******************************************************************/
    ...
    addForm(
      ...
      "provider_id = ?,device_type = ?, created_date = ?", // code added for BUG 10521 // Sai custom code
            array($today, $today, $reason, $facility, $facility_id, $patient_id,
        $encounter, $provider_id,$device_type,$todays_date)// code added for BUG 10521// Sai custom code
        ),
        "newpatient",
	$patient_id,
	$userauthorized,
