...
function generate_form_field($frow, $currvalue)
{
  ...
  // These data types support backup lists.
	...
	if($field_id_esc=='fname') $placeholder= 'First name';
	if($field_id_esc=='mname') $placeholder= 'Middle name';
	if($field_id_esc=='lname') $placeholder= 'Last name';
	if($field_id_esc=='genericname1') $placeholder= 'Generic name1';
	if($field_id_esc=='genericval1') $placeholder= 'Generic value1';
	if($field_id_esc=='genericname2') $placeholder= 'Generic name2';
	if($field_id_esc=='genericval2') $placeholder= 'Generic value2';
    ...
    echo "<input type='text'" .
      ...
      " value='$currescaped'";
		...
		if($field_id_esc == 'Alert_note')
		echo " onkeyup='limitText(this,50)' , onchange='capitalize(this.id)'";
		
		if($field_id_esc == 'col_alert')
		echo " onkeyup='limitText(this,50)' , onchange='capitalize(this.id)'";
	  
		if($field_id_esc == 'fname')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";	
		
		if($field_id_esc == 'mname')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";
		
		if($field_id_esc == 'lname')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";
...
PatienetName	fname, lname, mname
Guarantor`s Name:	guardiansname
Mother`s Name:	mothersname
Emergency Contact: 	contact_relationship
 Employer Name:	em_name
Subscriber: 	

isNumber	
	
ExternalID	
Postal Code:	gpostal_code
Emergency Phone: 	phone_contact
Postal Code:	postal_code
Home Phone:	phone_home
Work Phone:	phone_biz
Mobile Phone	phone_cell
Postal Code:	ecpostal_code
Home Phone:	ecphone_home
Mobile Phone:	ecphone_cell
Zip Code:	em_post_code*/

			  
		if($field_id_esc == 'ss')
		echo " onKeyUp='jm_ssnmask(this)' onBlur='ssnLength(this.value)' ";
		
		if (strpos($frow['edit_options'], 'C') !== FALSE)
		echo " onblur=capitalizeMe(this)',  onkeyup='policykeyup(this,event)'";	  
		else if (strpos($frow['edit_options'], 'U') !== FALSE)
		echo " onchange='this.value = this.value.toUpperCase()'";
		
		if ($field_id == 'gstreet')
		echo "onchange='capitalize(this.id)'";
		
		if ($field_id == 'gcity')
		echo " onkeypress='return isChar(event)'";
		...
		if ($field_id == 'ec_street')
		echo "onchange='capitalize(this.id)'";
		
		if ($field_id == 'em_street')
		echo "onchange='capitalize(this.id)'";
		
		if ($field_id == 'occupation')
		echo "onchange='capitalize(this.id)'";
		
		if ($field_id == 'deceased_reason')
		echo "onchange='capitalize(this.id)'";		
		
		if ($field_id == 'pubpid')
		echo "onkeypress='return isNumber(event)'";
		
		if($field_id_esc == 'guardiansname')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";
		
		if($field_id_esc == 'mothersname')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";
		
		if($field_id_esc == 'contact_relationship')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";		
		
		if($field_id_esc == 'em_name')
		echo " onkeypress='return isChar(event)' , onchange='capitalize(this.id)'";
		
		if ($field_id == 'gpostal_code')
		echo "onkeypress='return isNumber(event)' , onkeyup='zip_mask(this)' ";
		
		if ($field_id == 'phone_contact')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";
		
		if ($field_id == 'postal_code')
		echo "onkeypress='return isNumber(event)' , onkeyup='zip_mask(this)' ";
		
		if ($field_id == 'phone_home')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";
		
		if ($field_id == 'phone_biz')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";
		
		if ($field_id == 'phone_cell')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";
		
		if ($field_id == 'ec_postal_code')
		echo "onkeypress='return isNumber(event)' , onkeyup='zip_mask(this)' ";		
		
		if ($field_id == 'ec_phone_home')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";		
		
		if ($field_id == 'ec_phone_cell')
		echo "onkeypress='return isNumber(event)', onkeyup='phonekeyup(this,mypcc)' ";		
		
		if ($field_id == 'em_postal_code')
		echo "onkeypress='return isNumber(event)' , onkeyup='zip_mask(this)' ";
 // Sai custom code end			  
        ...
        " id='form_$field_id_esc'" .
        " title='$description'" .
       " onchange='capitalize(this.id)'" .
        " cols='$textCols'" .
        " rows='$textRows' $lbfonchange $disabled" .
        ">" . $currescaped . "</textarea>";// Sai custom code 
    } // date
    else if ($data_type == 4) {
...
function generate_print_field($frow, $currvalue)
{
  ...
  else if ($data_type == 10 || $data_type == 11 || $data_type == 35 || $data_type == 36 || $data_type == 37 || $data_type == 38) { // Sai custom code
        $tmp = '';
        if ($currvalue) {
  ...
  // Service Location list
    ...
    $tmp = '';
    if ($currvalue) {
      $urow = sqlQuery("SELECT id,pos_id,pos_name FROM pos_list " .
        "WHERE id = ?", array($currvalue) );
       $tmp = ucwords($urow['pos_name']);
      if (empty($tmp)) $tmp = "($currvalue)";
    }
     // Sai custom code end
    if ($tmp === '') { $tmp = '&nbsp;'; }
...
//
 // Sai custom code start
function dropdown_provider($selected = '', $name = 'form_provider', $allow_unspecified = true)
 {
  $have_selected = false;
  $query = "select id,concat(lname,' ',fname) as name from users where authorized = '1' ORDER BY name";
  ...
  $option_content = htmlspecialchars('-- ' . xl('All Providers') . ' --', ENT_NOQUOTES);
  echo "    <option value=\"$option_value\" $option_selected_attr>$option_content</option>\n";
...
function isOption($options, $test)
{
 ...
 // Sai custom code start
function echoLine11($lino, $codetype, $code, $modifier, $ndc_info='',
  $auth = TRUE, $del = FALSE, $units = NULL, $fee = NULL, $id = NULL,
  $billed = FALSE, $code_text = NULL, $justify = NULL, $provider_id = 0)
{ 
global $code_types, $ndc_applies, $ndc_uom_choices,$justinit1, $pid;
  ...
  if (! $code_text) {
    $query = "select id, units, code_text_short from codes where code_type = '" .
	...
	if(!$result)
	{
		echo "<html><head><script type='javascript'>alert('Please Enter Valid Code!!!')</script></head></html>";
	}
	else{
    $code_text = substr($result['code_text_short'],0,500);
  ...
  $price = $fee / $units;
  $total_charges = $units * $price;
  $strike1 = ($id && $del) ? "<strike>" : "";
  $strike2 = ($id && $del) ? "</strike>" : "";
  echo "<table border='0'  id='cpt_code_tbl' style='background-color:lightblue;'> <tr>\n";
  echo "  <td class='billcell' align='center' width='10%'>$strike1" .
    ($codetype == 'COPAY' ? xl($codetype) : $codetype) . $strike2;
  if ($id) {
    echo "<input type='hidden' name='bill[$lino][id]' value='$id' >";
  }
  echo "<input type='hidden'  id='bill[$lino][code_type]' name='bill[$lino][code_type]' value='$codetype'>";
  echo "<input type='hidden' name='bill[$lino][code]' value='$code'>";
  echo "<input type='hidden' name='bill[$lino][billed]' value='$billed'>";
  echo "</td>\n";
  if ($codetype != 'COPAY') {
    echo "  <td class='billcell' align='center' width='10%'>$strike1$code$strike2</td>\n";
  } else {
    echo "  <td class='billcell' align='center' width='10%'>&nbsp;</td>\n";
  }
  if ($billed) {  
    if (modifiers_are_used1(true)) {
      /*echo "  <td class='billcell' align='center' width='10%'>$strike1$modifier$strike2" .
        "<input type='hidden' name='bill[$lino][mod]' value='$modifier'></td>\n";*/
		 echo "  <td class='billcell' align='center' width='5%'>$strike1$modifier$strike2" .
        "<input type='hidden' name='bill[$lino][mod1]' value='$modifier1'></td>\n";
		echo "  <td class='billcell' align='center' width='5%'>$strike1$modifier$strike2" .
        "<input type='hidden' name='bill[$lino][mod2]' value='$modifier2'></td>\n";
		echo "  <td class='billcell' align='center' width='5%'>$strike1$modifier$strike2" .
        "<input type='hidden' name='bill[$lino][mod3]' value='$modifier3'></td>\n";
		echo "  <td class='billcell' align='center' width='5%'>$strike1$modifier$strike2" .
        "<input type='hidden' name='bill[$lino][mod4]' value='$modifier4'></td>\n";
    }
    if (fees_are_used1()) {    
      if ($codetype != 'COPAY') {
        echo "  <td class='billcell' align='center' width='10%' >$units</td>\n";		
      } else {
        echo "  <td class='billcell' align='center' width='12%' >&nbsp;</td>\n";		
      }
	    echo "  <td class='billcell' align='center' width='10%' >" . oeFormatMoney($price) . "</td>\n";
		$total_charges = $units * $price;
		echo "  <td class='billcell' align='center' width='10%' >$total_charges</td>\n";
      echo "  <td class='billcell' align='center' width='12%'$usbillstyle >$justify</td>\n";
    }

    // Show provider for this line.
    echo "  <td class='billcell' align='center' width='10%'>";
    genProviderSelect1('', '-- Default --', $provider_id, true);
    echo "</td>\n";
    echo "  <td class='billcell' align='center' width='5%'$usbillstyle><input type='checkbox'" .
      ($auth ? " checked" : "") . " disabled /></td>\n";
    echo "  <td class='billcell' align='center' width='5%'><input type='checkbox'" .
      " disabled /></td>\n";
  }
  else { // not billed
  
		echo "<script type='text/javascript'>newDiagJS1('$codetype','$code');</script>";	
		echo "<script type='text/javascript'>setJustify1(f['bill[$lino][justify]']);</script>";		
		
    if (modifiers_are_used1(true)) {
      if ($codetype != 'COPAY' && ($code_types[$codetype]['mod'] || $modifier)) {
        echo "  <td class='billcell' align='center' width='5%'><input type='text' name='bill[$lino][mod1]' " .
          "value='$modifier1' size='" . $code_types[$codetype]['mod1'] . "' style='width:80px'></td>\n";
		  echo "  <td class='billcell' align='center' width='5%'><input type='text' name='bill[$lino][mod2]' " .
          "value='$modifier2' size='" . $code_types[$codetype]['mod2'] . "' style='width:80px'></td>\n";
		  echo "  <td class='billcell' align='center' width='5%'><input type='text' name='bill[$lino][mod3]' " .
          "value='$modifier3' size='" . $code_types[$codetype]['mod3'] . "' style='width:80px'></td>\n";
		  echo "  <td class='billcell' align='center' width='5%'><input type='text' name='bill[$lino][mod4]' " .
          "value='$modifier4' size='" . $code_types[$codetype]['mod4'] . "' style='width:80px'></td>\n";
      } else {
        echo "  <td class='billcell' align='center' width='5%'>&nbsp;</td>\n";
		echo "  <td class='billcell' align='center' width='5%'>&nbsp;</td>\n";
		echo "  <td class='billcell' align='center' width='5%'>&nbsp;</td>\n";
		echo "  <td class='billcell' align='center' width='5%'>&nbsp;</td>\n";
      }
    ...
    if (fees_are_used1()) {
      if ($codetype == 'COPAY' || $code_types[$codetype]['fee'] || $fee != 0) {
        ...
        echo "  <td class='billcell' align='center' width='10%'>";
        if ($codetype != 'COPAY') {
          echo "<input type='text' name='bill[$lino][units]' id='bill[$lino][units]' " .
          "value='$units' size='2' style='text-align:right' style='width:80px' onblur='total_charges_calc();'>";		  
        } else {
          echo "<input type='hidden' name='bill[$lino][units]' id='bill[$lino][units]' value='$units'>";		
        }
        echo "</td>\n";
		 echo "  <td class='billcell' align='center' width='10%'>" .
          "<input type='text' name='bill[$lino][price]' id='bill[$lino][price]' " .
          "value='$price' size='6'";
        if (acl_check('acct','disc'))
          echo " style='text-align:right'";
        else
          echo " style='text-align:right;background-color:transparent' readonly";
        echo " style='width:80px' onblur='total_charges_calc();'></td>\n";
		$total_charges = $units * $price;
		echo "<td class='billcell' align='center' width='10%'><input type='text' id='bill[$lino][total_charges]' name='bill[$lino][total_charges]' " .
          "value='$total_charges' size='2' style='text-align:right' style='width:80px' onblur='total_charges_calc();'></td>";
		
        if ($code_types[$codetype]['just'] || $justify) {
          echo "  <td class='billcell' align='center'$usbillstyle>";
          echo "<select name='bill[$lino][justify]' onfocus='setJustify1(this)'  onchange='setJustify1(this)' >";
        ...
        echo "  <td class='billcell' align='center' width='10%'>&nbsp;</td>\n";
        echo "  <td class='billcell' align='center' width='10%'>&nbsp;</td>\n";
        echo "  <td class='billcell'$usbillstyle align='center' width='10%'>&nbsp;</td>\n"; // justify
      }
    }

    // Provider drop-list for this line.
    echo "  <td class='billcell' align='center' width='10%'>";
    genProviderSelect1("bill[$lino][provid]", '-- Default --', $provider_id);
    echo "</td>\n";
    echo "  <td class='billcell' align='center' width='10%'$usbillstyle><input type='checkbox' name='bill[$lino][auth]' " .
      "value='1'" . ($auth ? " checked" : "") . " /></td>\n";
    echo "  <td class='billcell' align='center' width='10%'><input type='checkbox' name='bill[$lino][del]' " .
      "value='1'" . ($del ? " checked" : "") . " /></td>\n";
  }

 /* echo "  <td class='billcell' align='center' width='10%'>$strike1" . ucfirst(strtolower($code_text)) . "$strike2</td>\n";*/
  echo " </tr>\n";
 ...
 /* if ($codetype == 'HCPCS' && $ndc_applies && !$billed) {
    ...
    echo " <tr>\n";
    echo "  <td class='billcell' colspan='2' align='center' width='10%'>&nbsp;</td>\n";
    echo "  <td class='billcell' colspan='6' align='center' width='10%'>&nbsp;NDC:&nbsp;";
    echo "<input type='text' name='bill[$lino][ndcnum]' value='$ndcnum' " .
      "size='11' style='background-color:transparent' style='width:80px'>";
    echo " &nbsp;Qty:&nbsp;";
    echo "<input type='text' name='bill[$lino][ndcqty]' value='$ndcqty' " .
      "size='3' style='background-color:transparent;text-align:right' style='width:80px'>";
    echo " ";
    echo "<select name='bill[$lino][ndcuom]' style='background-color:transparent' align='center' width='10%' style='width:80px'>";
...
function genProviderSelect1($selname, $toptext, $default=0, $disabled=false) {
...
/********************************************************************/
function fees_are_used1() {
 global $code_types;
 foreach ($code_types as $value) { if ($value['fee']) return true; }
 return false;
}

function modifiers_are_used1($fee_sheet=false) {
 global $code_types;
...
{
 echo '<script type="text/javascript">alert("Please enter valid code");document.getElementById("cpt_code").focus();</script>';
 return false;
}
// Generate JavaScript to build the array of diagnoses.
function genDiagJS1($code_type, $code) {
  if ($code_type == 'ICD9') {
    echo "diags.push('$code');\n";
  }
}
/*Added by Sonali: 9209:support for more than 6 CPT*/
function echocptline($cnt,$billid,$cpt_code,$pid,$disabled='',$mod1='',$mod2='',$mod3='',$mod4='',$total_charge='',$justify_arr='',$tos='',$units='',$fee='',$cpt_eaa=''){
echo "<tr style='background-color:lightblue;' id='addnewrow' >";
...
echo "<td><input type='text' name='bill[$cnt][code]' id='bill[$cnt][code]' size='10' value='$cpt_code' onKeyDown='PreventIt(event)' onblur='cpt_code_popup(this,$pid,$code_type)' autocomplete='off' $disabled><input type='hidden' id='bill[$cnt][code_type]' name='bill[$cnt][code_type]' value='CPT4' /></td>";
echo "<td><input type='text' name='bill[$cnt][mod1]' id='bill[$cnt][mod1]' value='$mod1' onchange='checkmodifier(this,$cnt,1)' onblur='mod_cpt_chk(this,$pid,$code_type)' size='5' maxlength='2' $disabled></td>";
//echo "<td><input type='text' name='bill[$cnt][mod1]' id='bill[$cnt][mod1]' value='$mod1' onchange='checkmodifier(this,$cnt,1)' size='5' maxlength='2' $disabled></td>";
echo "<td><input type='text' name='bill[$cnt][mod2]' id='bill[$cnt][mod2]' value='$mod2' onblur='checkmodifier(this,$cnt,2)' size='5' maxlength='2' $disabled></td>";
echo "<td><input type='text' name='bill[$cnt][mod3]' id='bill[$cnt][mod3]' value='$mod3' onblur='checkmodifier(this,$cnt,3)' size='5' maxlength='2' $disabled></td>";
echo "<td><input type='text' name='bill[$cnt][mod4]' id='bill[$cnt][mod4]' value='$mod4' onblur='checkmodifier(this,$cnt,4)' size='5' maxlength='2' $disabled></td>";
echo "<td><input type='text' name='bill[$cnt][justify]' id='bill[$cnt][justify]' onBlur='validatejustify(this.value,$cnt)' onkeyup='policykeyup(this,event)' size=8' value='$justify_arr[$cnt]' $disabled></td>";
echo "<td><input type='text' name='bill[$cnt][tos]' id='bill[$cnt][tos]' value='$tos' size='8'  readonly $disabled></td>";
...
/*echo "<td><input type='text' name='bill[$cnt][total_charges]' id='bill[$cnt][total_charges]'  value='$total_charge' onblur='total_charges_calc($cnt);' onchange='process();' size='8' $disabled readonly></td>";*/
echo "<td><input type='text' name='bill[$cnt][total_charges]' id='bill[$cnt][total_charges]'  value='$total_charge' onkeyup='addnewrow(event,$pid,$code_type);' onblur='total_charges_calc($cnt);'  size='8' $disabled readonly></td>";
// code added for cpt eaa amount
echo "<td><input type='text' name='bill[$cnt][cpt_eaa]' id='bill[$cnt][cpt_eaa]'  value='$cpt_eaa' onkeyup='addnewrow(event,$pid,$code_type);' onblur='total_charges_calc($cnt);'  size='8' $disabled readonly></td>";
echo "</tr>";
}
 // Sai custom code end
?>
